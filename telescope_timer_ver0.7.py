...
def moveRight(event):
    ...
    if slopeTelescopeBetelgeuseSupernova < -0.57 and slopeTelescopeBetelgeuseSupernova > -0.58:#-0.6:
        score = score + 10
...
score_label = Label(skyCanvas, text = "Score " + str(score), bg = "powder blue", font = ("Arial", 20))
score_label.place(x = 1800, y = 100)
